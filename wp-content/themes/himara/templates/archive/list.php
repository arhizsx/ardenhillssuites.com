<!-- Post List  -->
<div class="col-lg-12">
  <article id="post-<?php the_ID(); ?>" <?php post_class('post-item post-list-item');?>>
    <div class="row">
      <!-- Image -->
      <div class="col-lg-4">
        ...
        <figure class="post-thumbnail gradient-overlay-hover link-icon">
            <a href="<?php esc_url( the_permalink() ) ?>">
              <img src="<?php  echo the_post_thumbnail_url('himara_image_size_600_400')  ?>" class="img-fluid" alt="<?php echo the_title_attribute() ?>">
            </a>
        </figure>
        <?php endif ?>
      </div>
