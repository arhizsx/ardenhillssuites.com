...
Redux::setSection( $opt_name , array(
    ...
    'fields'          => array(
        ...
        array(
            ...
            'type'        => 'media',
            'url'         => false,
            'title'       => __( 'Hotel Logo', 'eagle-booking' ),
            'subtitle'    => __( 'Used for the email template and for the print page of the booking details.', 'eagle-booking' ),
        ),


        array(
            'id'         => 'slide_up_search_form',
            'type'       => 'switch',
            'class'       => 'small-text',
            'title'      => __('SlideUp Search Form', 'eagle-booking'),
            'subtitle'   => __( 'Show/Hide the SlideUp Search form', 'eagle-booking' ),
            'default'    => false,
        ),

        array(
            'id'         => 'slide_up_search_form_style',
            'type'       => 'button_set',
            'title'      => __('SlideUp Search Form Style', 'eagle-booking'),
            'subtitle'   => __( 'Choose how to display the SlideUp Search Form. Note: on mobile the SlideUp Search Form will be shown on scroll', 'eagle-booking' ),
            'multi'      => false,
            'options'    => array(
                'onclick'   => 'On Click',
                'onscroll'  => 'On Scroll',
            ...
            'default'    => 'onclick',
            'required'    => array( 'slide_up_search_form', '=', true ),
        ),
        ...
        array(
            ...
            'subtitle'   => esc_html__( 'Show/Hide the booking button in the main menu', 'eagle-booking' ),
            'default'    => true,
        ),
...
Redux::setSection( $opt_name , array(
    ...
    'fields'          => array(
        ...
        array(
            'id'         => 'room_slider_loop',
            'type'       => 'switch',
            'title'      => esc_html__( 'Slider Loop', 'eagle-booking' ),
            'subtitle'   => esc_html__( 'Enable/Disable the slider loop on room details page', 'eagle-booking' ),
            'default'    => true,
        ),
...
Redux::setSection( $opt_name , array(
    ...
    'fields'          => array(
      ...
      array(
        ...
        'options'    => array(
            'eagle_booking_image_size_370_485'     => esc_html__('370 x 485 (Rooms)', 'eagle-booking'),
