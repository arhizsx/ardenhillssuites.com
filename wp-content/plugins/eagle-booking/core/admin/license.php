...
class EB_LICENSE {
    ...
    public function theme_license() {
        ...
        if ( class_exists('Zante_License') || class_exists('Himara_Theme_License') || class_exists('Himara_License') ) {

           if ( class_exists('Zante_License') ) $theme_license = zante_license_status();
           if ( class_exists('Himara_Theme_License') ) $theme_license = theme_license_status();
           if ( class_exists('Himara_License') ) $theme_license = himara_license_status();
