...
if( !class_exists( 'ReduxFramework_registration' ) ) {
    ...
    class ReduxFramework_registration extends ReduxFramework {
        ...
        <input type="text" id="eth_purchase_code" class="eth-theme-purchase-code" name="himara_purchase_code" value="<?php echo $option_value['puchase_code'] ?>" class="regular-text">
